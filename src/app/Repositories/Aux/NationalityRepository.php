 ...
 */
class NationalityRepository extends AbstractAuxRepository implements NationalityRepositoryInterface
{
    ...
    {
        return $this->executeDelete($id, trans('models.nat.singular'));
    }
    ...
    public function getIndexViewVariables()
    {
        ...
        $variable = $this->generateViewPaginatorVariable($results, 'nats');
    ...
    public function getShowViewVariables($id)
    {
        ...
        $variable = $this->generateViewVariable($dept, 'nats');
        $variable->setDestView('nats.show');
    ...
    {
        $results = $this->generateViewVariable($this->newInstance(), 'nats');

        $results->setUsersGoal(trans('models.nats.create'));
        $results->setDestView('nats.store');
    ...
    public function getEditViewVariables($id)
    {
        ...
        return $this->generateViewVariable($dept, 'nats');
    }
}
